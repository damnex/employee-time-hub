...
import { LayoutDashboard, Users, Clock, ScanFace, Settings2 } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
  ...
  return (
    <Sidebar collapsible="icon" className="border-r border-sidebar-border/70 bg-sidebar/95 backdrop-blur">
      <SidebarHeader className="flex flex-row items-center gap-3 px-4 py-5 transition-[padding] duration-300 ease-in-out group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:px-3">
        <div className="flex aspect-square size-10 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-sidebar-border/70 bg-black shadow-sm">
          <img src="/logo.png" alt="Syncronize" className="h-full w-full object-cover" />
        </div>
